...
`,"getStyles")},68551:(t,e,s)=>{s.d(e,{P:()=>r});var i=s(7480),r=(0,i.K2)((t,e,s,r)=>{t.attr("class",s);let{width:o,height:l,x:c,y:h}=n(t,e);(0,i.a$)(t,l,o,r);let d=a(c,h,o,l,e);t.attr("viewBox",d),i.Rm.debug(`viewBox configured: ${d} with padding: ${e}`)},"setupViewPortForSVG"),n=(0,i.K2)((t,e)=>{let s=t.node()?.getBBox()||{width:0,height:0,x:0,y:0};return{width:s.width+2*e,height:s.height+2*e,x:s.x,y:s.y}},"calculateDimensionsWithPadding"),a=(0,i.K2)((t,e,s,i,r)=>`${t-r} ${e-r} ${s} ${i}`,"createViewBox")},82246:(t,e,s)=>{s.d(e,{A:()=>n});var i=s(7480),r=s(87795),n=(0,i.K2)((t,e)=>{let s;return"sandbox"===e&&(s=(0,r.Ltv)("#i"+t)),("sandbox"===e?(0,r.Ltv)(s.nodes()[0].contentDocument.body):(0,r.Ltv)("body")).select(`[id="${t}"]`)},"getDiagramElement")}}]);