...
export interface AutoBeAnalyzeReviewEvent
  ...
  /**
   * Name of the requirements analysis file being reviewed during the review phase.
   *
   * Represents the filename of the markdown document being reviewed and amended.
   * This file captures business context, functional requirements, technical 
   * specifications, architectural decisions, and implementation guidelines.
   */
  filename: string;

  /**
   * Content of the requirements analysis file being reviewed during the review phase.
   *
   * Contains the current state of the markdown document being created as part of
   * the requirements analysis. The content represents work-in-progress documentation 
   * that undergoes review and refinement before being finalized. This intermediate 
   * state provides transparency into the analysis generation process and allows for 
